import{_ as s,o as n,c as a,e as l}from"./app-BcH8wZQx.js";const e={},p=l(`<h1 id="页面相关" tabindex="-1"><a class="header-anchor" href="#页面相关"><span>页面相关</span></a></h1><p>这些函数为你的页面生成常见信息。</p><h2 id="getpageexcerpt" tabindex="-1"><a class="header-anchor" href="#getpageexcerpt"><span>getPageExcerpt</span></a></h2><p>获取页面摘要。</p><div class="language-typescript line-numbers-mode" data-ext="ts" data-title="ts"><pre class="shiki dark-plus" style="background-color:#1E1E1E;color:#D4D4D4;" tabindex="0"><code><span class="line"><span style="color:#C586C0;">export</span><span style="color:#569CD6;"> interface</span><span style="color:#4EC9B0;"> PageExcerptOptions</span><span style="color:#D4D4D4;"> {</span></span>
